...
Beipiel-Code wie die Pakete verwendet werden können, findet Ihr in der Datei main.go.
## English
My self-written go packages, for use in my or your projects.
For example code how to use the packages you can find in the file main.go.
